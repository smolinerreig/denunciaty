...
class Form {
	 ...
	 *        	filtrar caracteres especiales html
	 * @param boolean $check
	...
	public static function getField($field, $value = null, $is_check = FALSE, $filter = TRUE, $check = FALSE) {
		...
		if (Input::hasPost ( $field )) {
			$value = $is_check ? Input::post ( $field ) == $value : Input::post ( $field );
		} else if ($is_check) {
			$value = ( bool ) $check;
	 ...
	 *
	 * @param string $action
	 *        	Acción del formulario (opcional)
	 * @param string $method
	 *        	Por defecto es post (opcional)
	 * @param string $attrs
	 *        	Atributos de etiqueta (opcional)
	 * @return string
	 */
	 ...
	 * @param
	 *        	string|array Atributos de campo (opcional)
	 * @return string
	 */
	 ...
	 *        	Nombre de campo
	 * @param array $data
	 *        	Array de valores para la lista desplegable
	 * @param string|array $attrs
	 *        	Atributos de campo (opcional)
	 * @param string|array $value
	 *        	Array para select multiple (opcional)
	 * @param string $blank
	 *        	agrega un item vacio si es diferente de empty
	 * @param string $itemId
	 *        	En caso de usar array de objeto propiedad a tomar como id
	 * @param string $show
	 *        	texto a mostrar, si es empty usa el to string
	 * @return string
	 */
	 ...
	 *        	item de un array
	 * @param string $key
	 *        	valor de item dentro del select
	 * @param string $id
	 *        	valor posible de la propiedad del objecto para el value
	 * @return string
	 */
	 ...
	 * 
	 * @param string|array $value
	 *        	valor(es) que deben estar seleccionados
	 * @param string $key
	 *        	valor del item actual
	 * @return string
	 */
	 ...
	 *        	Nombre de campo
	 * @param string $checkValue
	 *        	Valor en el checkbox
	 * @param string|array $attrs
	 *        	Atributos de campo (opcional)
	 * @param boolean $checked
	 *        	Indica si se marca el campo (opcional)
	 * @return string
	 */
	 ...
	 *        	Nombre de campo
	 * @param string $show
	 *        	Campo que se mostrara (opcional)
	 * @param array $data
	 *        	Array('modelo','metodo','param') (opcional)
	 * @param string $blank
	 *        	Campo en blanco (opcional)
	 * @param string|array $attrs
	 *        	Atributos de campo (opcional)
	 * @param string|array $value
	 *        	(opcional) Array en select multiple
	 * @return string
	 */
