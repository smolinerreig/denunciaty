...
class Html {
	 ...
	 *
	 * @param array $array
	 *        	Array con el contenido del metatag
	 * @param string $type
	 *        	por defecto ul, y si no ol
	 * @param string|array $attrs
	 *        	atributos
	 * @return string
	 */
	 ...
	 *
	 * @param string $href
	 *        	direccion url del recurso a enlazar
	 * @param string|array $attrs
	 *        	atributos
	 */
	 ...
	 *        	ubicacion del recurso en public
	 * @param string|array $attrs
	 *        	atributos
	 */
	 ...
	 *
	 * @param string $email
	 *        	Correo para conseguir su gravatar
	 * @param string $alt
	 *        	Texto alternativo de la imagen. Por defecto: gravatar
	 * @param int $size
	 *        	Tamaño del gravatar. Un número de 1 a 512. Por defecto: 40
	 * @param string $default
	 *        	URL gravatar por defecto si no existe, o un default de gravatar. Por defecto: mm
	 * @return string
	 */
