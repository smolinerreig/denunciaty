...
class Redirect {
	 ...
	 *
	 * @param string $route
	 *        	ruta a la que será redirigida la petición.
	 * @param integer $seconds
	 *        	segundos que se esperarán antes de redirigir
	 * @param integer $statusCode
	 *        	código http de la respuesta, por defecto 302
	 */
	 ...
	 *
	 * @param string $action
	 *        	acción del controlador actual a la que se redirige
	 * @param integer $seconds
	 *        	segundos que se esperarán antes de redirigir
	 * @param integer $statusCode
	 *        	código http de la respuesta, por defecto 302
	 ...
	 * 
	 * @example Redirect::intern("module: modulo", "controller: nombre", "action: accion", "parameters: 1/2")
	 */
	 ...
	 * @example Redirect::route_to("module: modulo", "controller: nombre", "action: accion", "parameters: 1/2")
	 */
