...
class I18n {
	...
	/**
	 * Efectua una traducción.
	 * Cuando se pasan argumentos adicionales se remplaza con sprintf
	 *
	 * @example $saludo = I18n::get('Hola %s', 'Emilio')
	 *         
	 * @param
	 *        	string
	 * @return string
	 ...
	 * @param int $category
	 *        	categoria del mensaje (LC_CTYPE, LC_NUMERIC, LC_TIME, LC_COLLATE, LC_MONETARY, LC_MESSAGES, LC_ALL)
	 * @return string
	 *
	 */
