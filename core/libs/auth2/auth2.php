...
abstract class Auth2 {
	 ...
	 *
	 * @param string $field
	 *        	nombre de campo que recibe por POST
	 */
	 ...
	 *
	 * @param $login string
	 *        	Valor opcional del nombre de usuario en la bd
	 * @param $pass string
	 *        	Valor opcional de la contraseña del usuario en la bd
	 * @param $mode string
	 *        	Valor opcional del método de identificación (auth)
	 * @return bool
	 */
	...
	private function _checkSession() {
		...
		if ($_SERVER ['REMOTE_ADDR'] !== Session::get ( 'REMOTEADDR' ) || $_SERVER ['HTTP_USER_AGENT'] !== Session::get ( 'USERAGENT' )) {
			session_destroy ();
		}
	}
	 ...
	 *
	 * @param string $adapter
	 *        	nombre del adaptador por defecto
	 */
