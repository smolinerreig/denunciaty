...
class KumbiaView {
	 ...
	 *
	 * @param string $view
	 *        	nombre del view a utilizar sin .phtml
	 * @param string $template
	 *        	opcional nombre del template a utilizar sin .phtml
	 */
	 ...
	 *
	 * @param string $template
	 *        	nombre del template a utilizar sin .phtml
	 */
	 ...
	 * @param string $template
	 *        	Opcional nombre del template sin .phtml
	 */
	 ...
	 *
	 * @param string $path
	 *        	path de la vista sin extension .phtml
	 */
	...
	/**
	 * Obtiene el path para vista incluyendo la extension .
	 * phtml
	 *
	 * @return string
	 */
	 ...
	 *        	nombre de atributo (template, response, path, etc)
	 */
	 ...
	 *        	de vida de cache
	 * @param $type Tipo
	 *        	de cache (view, template)
	 * @param $group Grupo
	 *        	de pertenencia de cache
	 *        	
	 ...
	 * @param string $group
	 *        	grupo de cache
	 * @return string @throw KumbiaException
	 */
